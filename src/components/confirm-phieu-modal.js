...
function ConfirmPhieuModal({ setShow }) {
        ...
        <>
            <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg shadow-lg max-w-md w-full max-h-[90vh] overflow-y-auto px-6 py-6">
                    <h2 className="text-xl font-bold text-gray-800 mb-4 text-center">{r === 0 ? 'Xác nhận đồng ý phiếu' :  r === 1 ? 'Xác nhận đồng ý phiếu' : 'Chưa hoàn thành duyệt toa trong phiếu, không thể xác nhận'}</h2>
